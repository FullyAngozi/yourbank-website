import { CustomCard } from "../CustomQuotes";
        ...
        >
          ...
          <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
            ...
            <div className="hidden duration-700 ease-in-out" data-carousel-item>
             <CustomCard Card={CustomQuotes[0]} />
            </div>
            {/* Item 2 */}
            <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <CustomCard Card={CustomQuotes[1]} />
            </div>
            {/* <!-- Item 3 --> */}
            <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <CustomCard Card={CustomQuotes[2]} />
            </div>
            {/* <!-- Item 4 --> */}
            <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <CustomCard Card={CustomQuotes[3]} />
            </div>
            {/* <!-- Item 5 --> */}
            <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <CustomCard Card={CustomQuotes[4]} />
            </div>
          </div>
          {/* <!-- Slider indicators --> */}
